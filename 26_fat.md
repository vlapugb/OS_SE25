...
Тут связываем VFS и FAT ОС читает из dentry иноду соответвующую имени test, в нем помимо метаданных есть ссылка на сами данные Обращаемся к FAT в которой храниться таблица, читаем блоки по очереди, и в 339 блоке встречаем end of file. ура мы прочитали файл.
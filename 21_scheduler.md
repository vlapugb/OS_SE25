...
- Online - Это те задачи, которые Scheduler на ходу распределяет, изначально информации о них неизвестно

- Offline - Противоположность предыдущего типа, знаем всё о тасках, например, время выполнения
...
Starvation (Голод) - ситуация, когда процессу не достается ресурсов для выполнения

Deadline - дополнительное условие к таске, которое говорит, за сколько оно должно быть обработано(хоть доли секунды, хоть часы).
